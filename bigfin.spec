...
install -m 755 -d $RPM_BUILD_ROOT/%{_var}/lib/skyring
install -D bigfin $RPM_BUILD_ROOT/%{_var}/lib/skyring
install -m 755 -d $RPM_BUILD_ROOT/etc/skyring/providers.d/
install -D conf/ceph.conf $RPM_BUILD_ROOT/etc/skyring/providers.d/ceph.conf
