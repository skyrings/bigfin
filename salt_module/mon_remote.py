~/calamari/vagrant/devmode ~
/root/calamari/vagrant/devmode/Vagrantfile:5: warning: already initialized constant VAGRANTFILE_API_VERSION
/root/.vagrant.d/Vagrantfile:5: warning: previous definition of VAGRANTFILE_API_VERSION was here
import rados
