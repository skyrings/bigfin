...
func (s *CephProvider) GetClusterSummary(req models.RpcRequest, resp *models.RpcResponse) error {
	...
	*resp = utils.WriteResponseWithDataAndError(httpStatusCode, err_str, bytes, fmt.Errorf("%s", err_str))
	return nil
}
...
func (s *CephProvider) GetSummary(req models.RpcRequest, resp *models.RpcResponse) error {
	...
	*resp = utils.WriteResponseWithDataAndError(httpStatusCode, err_str, bytes, fmt.Errorf("%s - %s", ctxt, err_str))
	return nil
}
